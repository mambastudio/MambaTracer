...
public class CLSource {
    public static String[] readFiles()
    {
        ...
        String source7      = CLFileReader.readFile(CLSource.class, "Path.cl");
        String source8      = CLFileReader.readFile(CLSource.class, "ScanCompact.cl");
        String source9      = CLFileReader.readFile(CLSource.class, "Initialize.cl");
        String source10     = CLFileReader.readFile(CLSource.class, "Raytracing.cl");
        String source11     = CLFileReader.readFile(CLSource.class, "Rendering.cl");
        
        return new String[]{source1, source2, source3, source4, source5, source6, source7, source8, source9, source10, source11} ;
    }
}
