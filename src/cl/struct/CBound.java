 ...
 * @author user
 */
public class CBound extends FloatStruct implements AbstractBound<CPoint3, CVector3, CRay, CBound>
{
    ...
    public CBound(CPoint3 min, CPoint3 max)
    {
        this();
        include(min);
        include(max);   
    ...
    public void setBound(CBound bound)
    {
